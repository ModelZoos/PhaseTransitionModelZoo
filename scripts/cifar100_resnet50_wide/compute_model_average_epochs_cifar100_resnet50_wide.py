...
PATH_ROOT = Path("/ds2/model_zoos/taxonomy/cifar_100/zoos/Cifar-100/Resnet50_width_v2")
...
def main():
    ...
    # experiment name
    experiment_name = f"model_average_epochs_cifar-100_{model_type}_kaiming_uniform_{NUM_EPOCH}eps_width_{width_list[0]}-{width_list[-1]}"
    experiment_dir = PATH_ROOT

    # set training parameters
    root = Path(
        "/ds2/model_zoos/taxonomy/cifar_100/zoos/Cifar-100/Resnet50_width_v2/tune_zoo_cifar-100_Resnet50_width_kaiming_uniform_150eps_width_2-256"
    )
