...
PATH_ROOT = Path("/ds2/model_zoos/taxonomy/cifar_10/zoos/Cifar-10/Resnet50_width_v2")
...
def main():
    ...
    root = Path(
        "/ds2/model_zoos/taxonomy/cifar_10/zoos/Cifar-10/Resnet50_width_v2/tune_zoo_cifar-10_Resnet50_width_kaiming_uniform_150eps_width_2-256"
    )
