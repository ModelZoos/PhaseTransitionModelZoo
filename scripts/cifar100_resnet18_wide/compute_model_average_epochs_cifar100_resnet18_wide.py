...
PATH_ROOT = Path("/ds2/model_zoos/taxonomy/cifar_100/zoos/Cifar-100/Resnet18_width_v2")
...
def main():
    ...
    root = Path(
        "/ds2/model_zoos/taxonomy/cifar_100/zoos/Cifar-100/Resnet18_width_v2/tune_zoo_cifar-100_Resnet18_width_kaiming_uniform_150eps_width_2-256"
    )
