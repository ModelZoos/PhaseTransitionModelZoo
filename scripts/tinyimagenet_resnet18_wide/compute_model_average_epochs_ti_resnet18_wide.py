...
PATH_ROOT = Path(
    "/ds2/model_zoos/taxonomy/tiny_imagenet/zoos/TinyImageNet/Resnet18_width_v2"
)
...
def main():
    ...
    root = Path(
        "/ds2/model_zoos/taxonomy/tiny_imagenet/zoos/TinyImageNet/Resnet18_width_v2/tune_zoo_tinyimagenet_Resnet18_width_kaiming_uniform_100eps_width_4-256"
    )
