...
from ptmz.loss_landscape.curve_fitting_experiment import CurveTrainable
...
def main():
    ...
    # experiment name
    experiment_name = f"curve_cifar-10_{model_type}_kaiming_uniform_{NUM_EPOCH}eps_width_{width_list[0]}-{width_list[-1]}_bs128"
    ...
    config = {
        ...
        "curve::num_points": 5,
        "curve::num_bends": 3,
        "curve::fix_start": True,
        "curve::fix_end": True,
        "curve::lr": 0.1,
        "curve::weight_decay": 5e-4,
        "curve::momentum": 0.9,
        "curve::epochs": 10,
        "curve::batchsize": 128,
    }
