...
from ptmz.model_averaging.average_model_experiment import (
    ModelAverageTrainable,
)
...
def main():
    ...
    # experiment name
    experiment_name = f"model_average_seeds_cifar-10_{model_type}_kaiming_uniform_{NUM_EPOCH}eps_width_{width_list[0]}-{width_list[-1]}"
