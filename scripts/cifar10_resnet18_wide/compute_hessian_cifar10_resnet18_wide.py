...
from ptmz.loss_landscape.hessian_experiment import HessianTrainable
...
def main():
    ...
    # experiment name
    experiment_name = f"hessian_cifar-10_{model_type}_kaiming_uniform_{NUM_EPOCH}eps_width_{width_list[0]}-{width_list[-1]}"
