...
from ptmz.model_averaging.average_models import evaluate_averaged_models
import logging
...
class ModelAverageTrainable(Trainable):
    ...
    def step(self):
        ...
        # compute averagings
        averaging_results = evaluate_averaged_models(self.config, self.device)

        return averaging_results
